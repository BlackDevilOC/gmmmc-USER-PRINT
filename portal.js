(function () {
  ...
  const DEFAULT_PRINT_SETTINGS = {
    ...
    footer_font_size: 11,
    patient_info_padding_vertical: 18,
    patient_info_row_gap: 9,
    patient_info_label_width: 140,
    patient_info_bottom_margin: 15,
    ...
    display_pathologist_signature: true,
  ...
  function getPrintSettings() {
    ...
    const letterheadExtra = cfg.letterheadHeaderExtra ?? 72;
    return {
      ...merged,
      header_height: (merged.header_height || 140) + letterheadExtra,
    };
  }
...
.info-card { margin-bottom: 0; padding-top: 4px; padding-bottom: 4px; }
.info-grid { gap: 4px 16px; font-size: 11px; }
